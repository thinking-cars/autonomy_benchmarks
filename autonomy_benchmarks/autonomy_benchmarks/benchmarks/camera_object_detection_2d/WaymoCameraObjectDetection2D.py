...
from autonomy_benchmarks.utils.BoundingBox2DUtils import BoundingBox2DUtils
from autonomy_benchmarks.utils.ObjectDetectionUtils import (
...
class WaymoCameraObjectDetection2D(AutonomyBenchmark):
